...
namespace QuanLyVatTuXayDung22.Common.Resp
{
    ...
    public class MultipleResp : BaseResp
    {
        #region -- Methods --
        ...
        /// Initialize
        /// </summary>
        public MultipleResp() : base() { }

        /// <summary>
        /// Initialize
        /// </summary>
        /// <param name="message">Message</param>
        public MultipleResp(string message) : base(message) { }
        ...
        public MultipleResp(string message, string titleError) : base(message, titleError) { }
